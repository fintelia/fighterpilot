...
public:
	...
	private:
		...
		std::function<void()> mTransparentRenderFunc; //gets access to depth buffer FBO
	...
	public:
		...
		void setRenderFunc(std::function<void()> f){mRenderFunc = f;}
		void setTransparentRenderFunc(std::function<void()> f){mTransparentRenderFunc = f;}
		...
		void render(){if(mRenderFunc)mRenderFunc();}
		void renderTransparent(){if(mTransparentRenderFunc)mTransparentRenderFunc();}
