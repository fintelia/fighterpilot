...
{
	shared_ptr<modelAssetFile> asset = std::make_shared<modelAssetFile>();
	asset->name = name;
...
{
	shared_ptr<collisionMeshAssetFile> asset = std::make_shared<collisionMeshAssetFile>();
	asset->filename = filename;
	asset->objType = objType;
	assetFiles.push_back(asset);
}
void AssetLoader::addTexture(string filename,string name)
{
	shared_ptr<textureAssetFile> asset = std::make_shared<textureAssetFile>();
	asset->filename = filename;
	asset->name = name;
	assetFiles.push_back(asset);
}
