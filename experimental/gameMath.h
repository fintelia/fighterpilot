...
template <class T, class U> U taylor(T t, U x, U dx)
{
	return x + dx * t;
}
template <class T, class U> U taylor(T t, U x, U dx, U ddx)
{
	return x + dx * t + ddx * t*t / 2.0;
}
template <class T, class U> U taylor(T t, U x, U dx, U ddx, U dddx)
{
	return x + dx * t + ddx * t*t / 2.0 + dddx * t*t*t / 6.0;
}
