...
void main()
{
	...
	else
	{
		...
		if(height<0.1)
			...
			TexValues=vec4(1.0-(height-0.1)/0.05,(height-0.1)/0.05,0.0,0.0);
		else if(height<0.5)
			TexValues=vec4(0.0,1.0,0.0,0.0);
		else if(height<0.6)
			TexValues=vec4(0.0,1.0-(height-0.5)/0.1,(height-0.5)/0.1,0.0);
		else if(height<0.75)
			TexValues=vec4(0.0,0.0,1.0,0.0);
		else if(height<0.85)
			TexValues=vec4(0.0,0.0,1.0-(height-0.75)/0.1,(height-0.75)/0.1);
		else//f(height<1.0)
