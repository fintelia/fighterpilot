...
emitter::emitter(Type t, string tex, unsigned int initalCompacity):type(t),parentObject(0),texture(tex),friction(0.0),particles(NULL), vertices(NULL), compacity(initalCompacity), total(0), startTime(world.time()), extraTime(0.0), particlesPerSecond(30.0)
{
	if(compacity != 0)
	{
